//package com.homeflix.app.security;
//
//import com.homeflix.app.views.login.LoginView;
...
//        http.authorizeHttpRequests().requestMatchers(new AntPathRequestMatcher("/video/**/**")).permitAll();
//
